...
## Project Structure
    ...
    ├── testapiautosetting_115902  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_115902`
...
2. Clone this repo and `cd testapiautosetting_115902`
